                ...
                <form action="#">
                            ...
                            <div>
                                <label for="dificultad"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Difucultad</label>
                                <select id="countries"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <div>
                                <label for="recomendaciones"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Recomendaciones</label>
                            ...
                            <div>
                                <label for="restricciones"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Restricciones</label>
